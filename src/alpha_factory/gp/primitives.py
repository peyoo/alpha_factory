...
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, bool, bool], Expr, name="ts_signals_to_size"
)
...
# polars_ta.talib
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLABANDONEDBABY"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLDARKCLOUDCOVER"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLEVENINGDOJISTAR"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLEVENINGSTAR"
)
pset.addPrimitive(dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLMATHOLD")
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLMORNINGDOJISTAR"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_CDLMORNINGSTAR"
)
pset.addPrimitive(dummy, [Expr, Expr, Expr, Expr, int, int], Expr, name="ts_ADOSC")
...
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, int, int, int, int, int], Expr, name="ts_STOCH"
)
...
pset.addPrimitive(
    dummy,
    [Expr, Expr, float, float, float, float, float, float, float, float],
    Expr,
    name="ts_SAREXT",
)
...
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, Expr, Expr, float], Expr, name="ts_WINNER_COST"
)
...
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, int, int], Expr, name="ts_单阳不破选股"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, int, int], Expr, name="ts_回补跳空向上缺口"
)
...
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, Expr, Expr, int], Expr, name="ts_小步碎阳"
)
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, Expr, float], Expr, name="ts_跳空高开或低开"
)
pset.addPrimitive(dummy, [Expr, Expr, Expr, Expr, int], Expr, name="ts_昨日底部十字星")
pset.addPrimitive(
    dummy, [Expr, Expr, Expr, float, int, float, int], Expr, name="ts_放量上攻"
)
